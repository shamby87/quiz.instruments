...
public class LevelState {
    ...
    public LevelState(int index, int size) {
        this.index = index;
        this.size = size;
        this.solvedInstruments = new ArrayList<>(size);
    }
     ...
     */
    void solveInstrument(int index) {
    ...
    List<Integer> getUnsolvedInstruments(Storage storage) {
    ...
    public void forceComplete() {
        ...
        solvedInstruments = storage.getLevelInstruments(index);
    }
